	...
	<table cellpadding="0" cellspacing="0" class="formtable">
		...
		<tr>
			...
			<td>
				...
				<input type="submit" id="registersubmit" name="registersubmit" value="注册新用户" class="submit" onclick="<c:if test='${not empty registerRule }'>if(!checkClause()z){return false;}</c:if>ajaxpost('registerform', 'register');" tabindex="6" />
			</td>
		</tr>
		<tr>
			<th>&nbsp;</th>
...
<script type="text/javascript">
	...
	function checkUserName() {
		...
		//add by py
		var response=checkUser(userName);
      	if(response!="")
	   	{
	   	  warning(cu,response);
	   	  return;
