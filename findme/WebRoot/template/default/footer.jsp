 ...
 <c:if test="${empty tpl_noSideBar}">
  ...
  <div id="footer">
   ...
   <!-- <p>${sConfig.sitename} -  <a href="mailto:${sConfig.adminemail}">联系我们</a><c:if test="${not empty sConfig.miibeian}"> - <a  href="http://www.miibeian.gov.cn" target="_blank">${sConfig.miibeian}</a></c:if></p> -->
    <p class="unnamed1">                        
                                               &copy;2009-2010 51AnyGo 版权所有-<a href="mailto:51anygo@gmail.com">联系我们</a><a href="mailto:51anygo@gmail.com"></a><br/>
                            www.51AnyGo.cn, All Rights Reserved.
                            <br/>
                            <script src="http://s79.cnzz.com/stat.php?id=1685335&amp;web_id=1685335&amp;show=pic1" language="JavaScript" charset="gb2312"></script> <a href="http://www.miibeian.gov.cn/" target="_blank">粤ICP备09203808号</a>
